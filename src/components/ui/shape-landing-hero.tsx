                    ...
                    {children ? (
                        ...
                        <>
                            ...
                            >
                                ...
                                <span className="text-sm text-[var(--text-primary)] opacity-60 tracking-wide">
                                    {badge}
                                </span>
                            </motion.div>
                            ...
                            >
                                <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
                                    ...
                                    <span
                                        className={cn(
                                            "bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-[var(--text-primary)] to-rose-500"
                                        )}
                                    >
                                        {title2}
                                    </span>
                            ...
                            <motion.div
                                ...
                                animate="visible"
                            >
                                <p className="text-base sm:text-lg md:text-xl text-[var(--text-secondary)] opacity-60 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
